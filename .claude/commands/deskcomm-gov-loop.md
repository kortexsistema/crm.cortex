---
description: Executa UMA sessão do gov-loop do Kortex (uma feature de governança, depois morre)
---
Execute o protocolo do gov-loop — Kortex (Governança de Atendimento): leia
