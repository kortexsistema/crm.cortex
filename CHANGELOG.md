...
Se você roda o Kortex numa VPS, **leia a seção da versão para a qual está atualizando antes de rodar `bash update.sh`**. Mudanças que exigem ação manual aparecem sob **⚠️ Requer atenção**.
...
Primeira versão marcada do Kortex. O projeto vinha sendo desenvolvido publicamente desde abril de 2026 sem tags; esta release estabelece o ponto a partir do qual toda mudança passa a ser versionada e descrita — porque quem hospeda o próprio sistema precisa saber o que muda antes de atualizar.
...
- Imagem publicada em `ghcr.io/kortexsistema/kortex-v1` — a VPS não compila nada.
...
[Não lançado]: https://github.com/kortexsistema/kortex-v1/compare/v1.1.0...HEAD
[1.1.0]: https://github.com/kortexsistema/kortex-v1/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/kortexsistema/kortex-v1/releases/tag/v1.0.0
