...
- **VPS de prova:** http://129.121.45.100:18080 (compose `kortex-fusion`, deploy por git bundle — ver docs/vendaval-vps-deploy-comandos.md).
...
- VPS = http://129.121.45.100:18080, compose `kortex-fusion`, banco Supabase cloud `cnbzyadxiwrfrylywejj` (role `agent_worker` no `.env`).
