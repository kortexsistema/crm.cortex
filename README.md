...
# 🛠️ Kortex — o Sistema Operacional de Vendas com IA, open source, pro WhatsApp
...
[![CI](https://github.com/kortexsistema/kortex-v1/actions/workflows/ci.yml/badge.svg)](https://github.com/kortexsistema/kortex-v1/actions/workflows/ci.yml)
...
>
> O Kortex foi desenvolvido em **parceria com a HostGator**: o [`hostgator-setup-kit/`](hostgator-setup-kit/)
...
>
> ```bash
> curl -fsSL https://raw.githubusercontent.com/kortexsistema/kortex-v1/main/hostgator-setup-kit/comecar.sh | bash
> ```
>
...
>
> ```bash
> git clone https://github.com/kortexsistema/kortex-v1.git
> cd Kortex
...
**Kortex** vem de **Desk** (mesa) + **comm** (comércio): **o comercial de mesa** — toda a operação de vendas do seu negócio numa mesa só, operada por pessoas e agentes de IA juntos.
...
Abra uma [issue](https://github.com/kortexsistema/kortex-v1/issues/new/choose) — o template pede o que precisamos (ambiente, `/api/v1/health`, steps).

Pra **vulnerabilidades de segurança**, **NÃO abra issue pública** — use o [relato privado de vulnerabilidades](https://github.com/kortexsistema/kortex-v1/security/advisories/new). Detalhes em [`SECURITY.md`](SECURITY.md).
...
- **MCP público** — capabilities do CRM expostas pro ecossistema de agentes: plugue o agente que quiser e ele opera o Kortex.
...
- **Discussões:** [GitHub Discussions](https://github.com/kortexsistema/kortex-v1/discussions) — pra perguntas, ideias, showcase.
- **Issues:** [GitHub Issues](https://github.com/kortexsistema/kortex-v1/issues) — bugs e tasks.
...
- **Suporte é comunitário e "as-is".** Dúvidas e bugs entram como
  [Issues](https://github.com/kortexsistema/kortex-v1/issues) ou
  [Discussions](https://github.com/kortexsistema/kortex-v1/discussions). Não há SLA nem
