...
const formSchema = z.object({
  ...
  owner_password: z.string().min(8, "A senha deve ter no mínimo 8 caracteres").max(72, "A senha deve ter no máximo 72 caracteres"),
});
          ...
          <form onSubmit={onSubmit} className="space-y-5" noValidate>
            ...
            <div className="space-y-1.5">
              <Label htmlFor="owner_password">
                Senha do responsável <span className="text-error-fg">*</span>
              </Label>
              <Input
                id="owner_password"
                type="password"
