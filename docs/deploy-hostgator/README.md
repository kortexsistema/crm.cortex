# Como subir o seu Kortex na HostGator (passo a passo, sem enrolação)
...
```
Seu domínio  →  Servidor VPS (HostGator)  →  Kortex rodando
                        │
                        ├─ o CRM (site + painel)
...
O Kortex roda num **VPS com Docker**. A opção mais fácil é um VPS que **já vem
...
2. Escreva pra ele exatamente isto:
   ...
   > *"Clone https://github.com/kortexsistema/kortex-v1 e me instale o Kortex
...
O Kortex foi desenhado pra rodar redondo na infraestrutura da HostGator. Além do
