# Kortex self-hosted — instalação em VPS (com agente de IA)
...
```bash
git clone https://github.com/kortex/kortex.git && cd kortex
...
- **Backup diário** (do seu crontab na VPS):
  `0 3 * * * /caminho/repo/scripts/backup-db.sh /var/backups/kortex`
