...
Sócio ou líder da operadora BPO. Acessa via `admin.kortex.com`. **Não fica no painel passivo** — a maior parte do tempo está na inbox cross-tenant operando como operador, mas com poderes de triagem e supervisão. MFA TOTP obrigatório.
