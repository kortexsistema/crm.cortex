...
> Árvore canônica de rotas do Kortex. Toda tela construída deve aparecer aqui. Persona, auth e prioridade por rota; layouts pais explícitos. Convenção Next.js 14 App Router.
...
## 4. Super-admin de plataforma (`/admin`, subdomínio `admin.kortex.com`)
