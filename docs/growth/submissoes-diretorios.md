...
**Como funciona:** a submissão **não** vai no README. Vai como um arquivo YAML em [`awesome-selfhosted-data`](https://github.com/awesome-selfhosted/awesome-selfhosted-data), em `software/kortex.yml`, um item por PR, nome de arquivo em kebab-case.

**Entrada pronta:** `docs/growth/awesome-selfhosted-kortex.yml`. É só copiar o conteúdo abaixo dos comentários. Os nomes de tag e plataforma foram conferidos em 28/07/2026 contra o campo `name:` de cada arquivo do repositório deles — **não** contra o nome do arquivo, que é diferente (`customer-relationship-management-crm.yml` declara `Customer Relationship Management (CRM)`). Referenciar pelo nome do arquivo é a rejeição mais comum.
...
Nome da alternativa: `Kortex` · Repositório: `https://github.com/kortexsistema/kortex-v1`
