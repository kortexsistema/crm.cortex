...
**Branch:** `feat/canais-oficial` · **Worktree:** `~/Kortex-canais`
...
continuam idênticos e verdes. Commitado com `KORTEX_GOV_INVARIANTS_EDIT=1` citado no
commit message.
