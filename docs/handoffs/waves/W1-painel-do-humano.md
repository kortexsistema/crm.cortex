...
**Worktree:** `/Users/rafaelmelgaco/Kortex-ia360-w1-painel` (branch `feat/ia-360-w1-painel`, base `d25cd1c`)
...
O resumo do porquê: o Kortex tem um agente de IA que sabe conversar mas não sabe operar, e o
