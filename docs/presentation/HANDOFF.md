...
- ✅ **Repositório no GitHub**: https://github.com/kortexsistema/kortex-v1
...
| **GitHub repo** | https://github.com/kortexsistema/kortex-v1 (private) |
...
- **Memórias persistentes do projeto** em `~/.claude/projects/-Users-rafaelmelgaco-Kortex/memory/`
  ...
  - `project_naming_and_timeline.md` — Kortex, MVP-B 8-12 semanas
...
- Pitch deck pode ser renderizado com:
  ...
  ```
- GitHub repo: https://github.com/kortexsistema/kortex-v1 (mostre as docs)
- Supabase Studio: dashboard.supabase.com → projeto Kortex → Database → Tables (31 tabelas com RLS verde)
