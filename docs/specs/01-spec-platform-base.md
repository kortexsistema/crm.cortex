...
> Spec foundational do Kortex. Define schema SQL completo, RLS policies, fluxos de auth, contratos de API REST `/api/v1/`, endpoints LGPD e onboarding de tenant. Toda spec posterior (Customer 360, WhatsApp, Pipeline, IA, Nuvemshop) **depende** desta. Divergências exigem ADR explícito.
...
Tenant criado:
  ...
  Slug:  loja-exemplo
  URL:   https://loja-exemplo.kortex.com (DNS pending)
  Admin invite: https://app.kortex.com/invite/<jwt-1h>
...
Wizard em `https://admin.kortex.com/tenants/new` com mesma sequência:
...
export const log = pino({
  ...
  base: { service: 'kortex-api', env: process.env.NODE_ENV },
  redact: {
