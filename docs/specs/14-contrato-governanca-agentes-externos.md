...
> Kortex via MCP: quais tools existem, o input/output exato de cada uma, a
...
O Kortex expõe um **servidor MCP org-scoped**. O agente externo se autentica
...
> Kortex**; o lado do Vendaval é o FG-01.
