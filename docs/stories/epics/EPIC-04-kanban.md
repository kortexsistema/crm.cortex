...
| Vocabulary inconsistente (string hardcoded em PT) | Baixa | Linter `eslint-plugin-kortex/no-hardcoded-pt-in-kanban` (regra P-07) — adicionar em S-04.06 se ausente |
