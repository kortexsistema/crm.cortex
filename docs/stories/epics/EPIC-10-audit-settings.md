...
- **W9 — Billing**: `/app/settings/billing` static placeholder card pointing to `suporte@kortex.app`.
...
Placeholder explícito pra não deixar item quebrado na sidebar de settings. Mostra mensagem "Em breve" + benefícios do plano + link `mailto:contato@kortex.com.br?subject=Billing` ou link pro WhatsApp da Kortex. Nenhuma lógica de billing real.
...
And botão "Falar com a Kortex" abre mailto
```
