...
research_dossier: ~/tino-ai/Tino/research/pre-development/ai-agent-framework-kortex-whatsapp/
specs:
...
> - **Research dossier** (`~/tino-ai/Tino/research/pre-development/ai-agent-framework-kortex-whatsapp/`) — decisão de stack e tradeoffs
>
...
- **Research dossier** (decisão de stack):
  - `~/tino-ai/Tino/research/pre-development/ai-agent-framework-kortex-whatsapp/00-brief.md` ... `09-handoff.md`
