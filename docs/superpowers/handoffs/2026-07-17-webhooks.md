...
- **Onde:** worktree `/Users/rafaelmelgaco/Kortex/.claude/worktrees/webhooks`, branch `feat/webhooks-automation` (base origin/main). Checkout principal está no `gov/G4` com trabalho do gov-loop — NÃO tocar nele.
...
**PUSH FEITO (autorizado pelo Rafael, --no-verify explícito) + PR ABERTO: https://github.com/kortexsistema/kortex-v1/pull/8**
