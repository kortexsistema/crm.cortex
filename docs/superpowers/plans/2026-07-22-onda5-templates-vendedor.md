...
- [ ] **Step 2: Criar template na UI** — em `/app/templates`, criar um template pessoal (ex.: título "Saudação", corpo "Oi {{primeiro_nome}}! Aqui é da Kortex 👋", shortcut "oi") e um compartilhado. Screenshot da lista.
