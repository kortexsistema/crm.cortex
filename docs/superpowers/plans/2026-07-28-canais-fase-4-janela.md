...
Com o destinatário `5531998966398` já registrado e o template `kortex_prova_webhook_0088` (pt_BR, 2 parâmetros) aprovado na WABA de teste: envie **por este caminho** e prove o `wamid`. Grave em `evidence/canais/fase4/`.
