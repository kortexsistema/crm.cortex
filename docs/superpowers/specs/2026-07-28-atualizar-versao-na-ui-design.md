# Atualizar o Kortex pela própria tela
...
Quem hospeda o Kortex numa VPS atualiza hoje assim: abre um terminal, conecta por SSH
...
O app roda dentro de um container (`ghcr.io/kortexsistema/kortex-v1`) sem nenhum volume do host.
...
- Sobe `APP_IMAGE=ghcr.io/kortexsistema/kortex-v1:<versão>` em vez de `latest`.
