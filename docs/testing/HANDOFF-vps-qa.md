...
- **Deps:** WAHA Core local (`kortex-waha`, :3030), Redis + serverless-redis-http
...
- **Worktree:** `~/Kortex-qa` (branch `qa/vps-experience`), `node_modules`
...
- **M3** — README self-host aponta repo/imagem `kortex/*`; kit usa `melgarafael/*`.
