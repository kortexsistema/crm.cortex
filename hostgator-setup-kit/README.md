# Kortex — Kit de Instalação (HostGator)

Este kit sobe o **Kortex** no seu servidor VPS da HostGator. Você tem dois caminhos:
...
3. Diga: *"instala o Kortex pra mim"*. Ele lê o `CLAUDE.md` e conduz tudo —
