...
governança). Alertas de runtime do produto seguem os canais do próprio Kortex
...
4. **Só o humano destrava**: escreve em `resposta do humano`, muda `status: answered`.
   ...
   **o gancho operacional está no LOOP.md §1.7**: ANTES de implementar, ler a
   ...
   `KORTEX_GOV_PLAN_EDIT=1`), e o item fica `answered` até o features.json
   refletir a mudança.
