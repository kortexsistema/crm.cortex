...
# sem KORTEX_GOV_INVARIANTS_EDIT=1.
...
[ "${KORTEX_GOV_INVARIANTS_EDIT:-0}" = "1" ] && exit 0
...
if [ -n "$violations" ]; then
  ...
  echo "Nesse caso: exporte KORTEX_GOV_INVARIANTS_EDIT=1 e cite o flip no commit message." >&2
  exit 1
fi
