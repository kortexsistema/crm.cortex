...
const USERS: Array<{
  ...
  { email: "e2e-admin@kortex.test", role: "admin", full_name: "E2E Admin" },
  { email: "e2e-manager@kortex.test", role: "manager", full_name: "E2E Manager" },
  { email: "e2e-agent@kortex.test", role: "agent", full_name: "E2E Agent" },
  { email: "e2e-viewer@kortex.test", role: "viewer", full_name: "E2E Viewer" },
];
