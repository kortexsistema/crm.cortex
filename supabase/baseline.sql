...
COMMENT ON SCHEMA "public" IS 'Kortex v0.1 - Migration 0001 platform_base applied 2026-04-28';
...
COMMENT ON TABLE "public"."organizations" IS 'Tenants do Kortex. Cada linha = 1 e-commerce cliente.';
...
create table if not exists playbook_versions (
  ...
  layer text not null check (layer in ('platform', 'domain', 'tenant', 'campaign')),
...
-- =============================================================================
-- Migration 0116 — Playbook Domain Layer
-- =============================================================================
...
-- =============================================================================
-- Migration 0117 — Auto Provision Org
-- =============================================================================
...
-- ---- fn_get_user_id_by_email (migration 0118) ----
...
-- [APPENDIX] 0123_add_tenant_tokens_and_platform_settings.sql
ALTER TABLE "public"."organizations" ADD COLUMN IF NOT EXISTS "tokens_balance" integer DEFAULT 0 NOT NULL, ADD COLUMN IF NOT EXISTS "tokens_cycle_end_at" timestamp with time zone, ADD COLUMN IF NOT EXISTS "tokens_extra_status" text DEFAULT 'none' NOT NULL CHECK ("tokens_extra_status" IN ('none', 'requested', 'granted'));

CREATE TABLE IF NOT EXISTS "public"."platform_settings" ("id" text PRIMARY KEY, "value_encrypted" bytea NOT NULL, "value_iv" bytea NOT NULL, "value_tag" bytea NOT NULL, "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL);
ALTER TABLE "public"."platform_settings" OWNER TO "postgres";
ALTER TABLE "public"."platform_settings" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Platform Admins can read settings" ON "public"."platform_settings" FOR SELECT TO authenticated USING (exists (select 1 from public.platform_admins pa where pa.user_id = auth.uid()));
CREATE POLICY "Platform Admins can modify settings" ON "public"."platform_settings" FOR ALL TO authenticated USING (exists (select 1 from public.platform_admins pa where pa.user_id = auth.uid())) WITH CHECK (exists (select 1 from public.platform_admins pa where pa.user_id = auth.uid()));
...
-- ---------------------------------------------------------------------------
-- Ap�ndice: Corrigir restri��o de provedores para aceitar openrouter
-- ---------------------------------------------------------------------------
